...
From here I noticed the flag in the following form

{3 n h 4 n and c 3 d \_ 6 7 8 3 c c 4 6}

After adding the picoCTF wrapper the flag had the following format picoCTF{3nh4nc3d_6783cc46}
